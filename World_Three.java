...
public class World_Three {
	...
	public static void main(Role role) throws Exception{
		System.out.println("> Welcome to World 3");
		...
		System.out.println("> Dear stranger, welcome to my carriage. \n> You are automatically a participant in my game,  and I will present mysterious situations to you. \n> Find out the truth behind the veil that I did not tell you by asking further questions. \n> I will only answer \"yes\" or \"no\" to your questions.");
		System.out.println("> Listen to me carefully.../n");
		System.out.println("> A black cat is hiding in a the middle of a road where there is an unlit street lamp. \n> A man is driving his vehicle with no lights to speak of. \n> Despite all of this, he is able to see and avoid harming the cat. \n> HOW DID HE DO THIS?");
		//Answer Riddle Loop
		int count = 3;
		String guess = "";
		int correct = 0;
		while (count > 0 && correct ==0) {
			...
			if (guess.charAt(guess.length() - 1) == '?') {
				if (guess.contains("cat") && guess.contains("magic")) {
					...
					System.out.println("> Your question is not relevant");}
			}
		...
		if (correct == 1) {
			...
			System.out.println("> You believe the crystal has lied about something… \n> perhaps if you say what, it will let you go");
			//Second Riddle
			guess = "";
